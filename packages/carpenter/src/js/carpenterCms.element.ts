...
import {
  TCarpenterCmsComponent,
  TCarpenterCmsNotification,
  TCarpenterCmsSpecs,
  TCarpenterCmsState,
  TCarpenterCmsUpdateComponentSettings,
} from '../shared/carpenterCms.type.js';
...
export default class CarpenterCmsElement extends __LitElement {
  ...
  @state()
  // @ts-ignore
  public specs: TCarpenterCmsSpecs = {};

  @state()
  public _notifications: TCarpenterCmsNotification[] = [];

  @state()
  public _selectedComponent: TCarpenterCmsComponent | null = null;
  ...
  @state()
  public _components: Record<string, TCarpenterCmsComponent> = {};
  ...
  public get selectedComponent(): TCarpenterCmsComponent {
  ...
  public get preselectedComponent(): TCarpenterCmsComponent | null {
  ...
  private async _postComponent(
    ...
    settings: TCarpenterCmsUpdateComponentSettings = {},
  ): Promise<void> {
    const finalSettings = {
  ...
  public setComponent(
    pathOrId: string,
    newComponent: TCarpenterCmsComponent,
  ): void {
    const component = this.getComponent(pathOrId);
    this._components[component.id] = newComponent;
  }

  public getComponent(pathOrId: string): TCarpenterCmsComponent {
  ...
  private async _sendNotification(
    notification: TCarpenterCmsNotification,
  ): Promise<void> {
