import { TComponentsComponentJson, TComponentsComponentObject, TComponentsSettings } from '@lotsof/components';
import { TJsonSchemaFormUpdateObject, TJsonSchemaFormWidget } from '@lotsof/json-schema-form';
...
export type TCarpenterCmsAdapter = {
    applyUpdate(TCarpenterCmsUpdateObject: any): void;
};
