...
<li class="docmap_item">
<span class="docmap_name">[disconnectedCallback=undefined] A function to call when a node is disconnected from the dom<span class="docmap_required">*</span></span><span class="docmap_default">-</span> <span class="docmap_type">Function</span>
