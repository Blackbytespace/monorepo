...
description: 'Detect if the user prefer the dark mode. If you pass a &quot;rootNode&quot;, it will check by querying up the DOM if an element has the class `-dark` on it.'
type: 'Function'
status: 'stable'
since: '1.0.0'
