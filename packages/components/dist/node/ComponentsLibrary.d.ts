import type { TComponentsLibraryJson, TComponentsLibrarySettings, TComponentsLibraryUpdateResult } from './Components.types.js';
...
export default class ComponentsLibrary {
    ...
    updated: boolean;
    get settings(): TComponentsLibrarySettings;
    get componentsJson(): TComponentsLibraryJson;
    get name(): string;
    ...
    update(): Promise<TComponentsLibraryUpdateResult>;
}
