...
import { __escapeQueue, __escapeQueueLength, __hotkey, } from '@lotsof/sugar/keyboard';
...
import __logoCarpenter from './assets/logoCarpenter.js';
...
export default class CarpenterCmsElement extends __LitElement {
    ...
    _initListeners(context) {
        ...
        __hotkey('escape', (e) => {
            this._currentAction = null;
            const escapeQueue = __escapeQueue();
            if (__escapeQueueLength() === 0) {
                this.hideUi();
            }
        }, hotkeySettings);
    ...
    _initEnvironment() {
        this.log(`Init the carpenter cms environment...`);
    ...
    _renderTopbar() {
      ...
      <h1 class="${this.cls('_topbar-title')}">${__logoCarpenter}</h1>
    ...
    render() {
        return html `
      ${this._renderTopbar()} ${this._renderEditor()}
      ${this._currentAction === 'saveValues'
...
], CarpenterCmsElement.prototype, "src", void 0);
__decorate([
    property({ type: String })
], CarpenterCmsElement.prototype, "commandPanelHotkey", void 0);
__decorate([
    property({ type: String })
], CarpenterCmsElement.prototype, "darkModeClass", void 0);
__decorate([
    state()
    // @ts-ignore
], CarpenterCmsElement.prototype, "specs", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_notifications", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_selectedComponent", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_selectedComponentId", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_preselectedComponentId", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_components", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_currentAction", void 0);
__decorate([
    state()
], CarpenterCmsElement.prototype, "_showEditor", void 0);
__decorate([
    state()
