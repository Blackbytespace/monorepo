...
export default class GitSource extends ComponentSource {
    constructor(name, repositoryUrl, settings = {}) {
        super(name);
        this.settings = {};
        this.settings = Object.assign({ localDir: `${__homedir()}/.lotsof/components/git` }, settings);
        this._repositoryUrl = repositoryUrl;
        this._repositoryName = repositoryUrl.split('/').pop().replace('.git', '');
    }
    update(args) {
